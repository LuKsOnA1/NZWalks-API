...
using NZWalks.API.Repositories.API.Concrete;
using NZWalks.API.Repositories.Identity.Abstract;
using NZWalks.API.Repositories.Identity.Concrete;
using NZWalks.API.Data.Identity;
...
{
    // Modifying swagger document to use Authorization
...
// Adding Authentication and JwtBearer configuration
